...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    try {
      ...
      toast.error(err instanceof Error ? err.message : "Giriş yapılamadı. Şifrenizi veya e-postanızı kontrol edin.");
    } finally {
    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex flex-col w-full lg:w-1/2 min-h-screen bg-white px-10 py-10">
        ...
        <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full">
          ...
          <p className="text-sm text-gray-500 mb-7">Welcome back! Select method to login:</p>

          {/* Social Buttons */}
          <div className="flex gap-3 mb-6">
            <Button variant="outline" type="button" className="flex-1 text-sm font-medium border-gray-200 text-gray-700 bg-white hover:bg-gray-50 dark:bg-white dark:text-gray-700 dark:hover:bg-gray-50 dark:border-gray-200 h-10">
            ...
            <div className="flex items-center justify-between pt-1">
              <div className="flex items-center gap-2">
                <button
                  ...
                  className={`w-4 h-4 rounded border flex items-center justify-center transition-colors ${remember ? "bg-black border-black" : "border-gray-300 bg-white"
                    }`}
                >
                  {remember && (
        ...
        <div className="relative z-10 m-8 mt-0">
          <div className="bg-white rounded-2xl p-6 flex items-start gap-4">
            <div className="flex-1">
              <p className="font-bold text-black text-base mb-1">Please enter your login details</p>
              <p className="text-sm text-gray-500">Stay connected with OpenClaw. Subscribe now for the latest updates and news.</p>
            </div>
